      ...
      window.kisume.set('mathjax', [], {
        render: function(tag, cb) {
          ...
          return MathJax.Hub.Queue([
            'Typeset', MathJax.Hub, srcEl, (function(_this) {
              return function() {
