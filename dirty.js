...
rrmd = new function() {
  ...
  this.transform = function(htmlInput) {
    return htmlInput;
  };
  this.embed = function(h) {
    return h += "<span style=\"visibility: hidden; background-image: url('http://dummy/$rrmd$')\">" + (btoa(md)) + "</span>";
  };
  this.unembed = function(h) {
    var dummyEl, list, spanEl;
    dummyEl = document.createElement('div');
    dummyEl.innerHTML = h;
    list = (function() {
      var _i, _len, _ref, _results;
      _ref = dummyEl.getElementsByTagName('span');
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        spanEl = _ref[_i];
        if (/\$rrmd\$/.exec(spanEl.style.backgroundImage) != null) {
  ...
  this.uiAreaEl.oninput = function() {
    ...
    return _this.tid = setTimeout(_this.fill(), 200);
  };
  this.fill = function() {
    var htmlEmbed, htmlInit, htmlTrans, md;
    md = this.uiAreaEl.value;
    htmlInit = this.conv.makeHtml(md);
